...
const Navbar = () => {
  return (
    <div className='flex items-center justify-between px-4 py-4 bg-purple-600'>
        ...
        <div>
            <ul className='flex items-center justify-center gap-8 font-bold   border-white px-10 py-3 rounded-2xl '>
        ...
        <div className='font-bold text-2xl px-4 py-2 rounded-2xl hover:bg-purple-950 hover:text-white  border-white  '>
